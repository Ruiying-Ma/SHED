...
def gen_deep_clustering(orig_cluster_json_path, dst_cluster_json_path):
    ...
    for oi in orig_items:
        if 'cluster_id' in oi:
            oi['cluster_id'] = cluster_id_counter
...
def grobid2sht(dataset):
    grobid_dir = os.path.join("/home/ruiying/SHTRAG/data", dataset, "deep")
    ...
    #     sht_builder.build(objects, 'deep')
    #     sht_builder.check()
    ...
    #     try:
    #         sht_path = f"/home/ruiying/SHTRAG/data/{dataset}/deep/sbert.gpt-4o-mini.c100.s100/sht/{file_name}.json"
...
if __name__ == "__main__":
    ...
    for dataset in ['qasper']:
        ...
        # deep_cluster_folder = f"/home/ruiying/SHTRAG/data/{dataset}/deep/node_clustering"
        ...
        #         dst_cluster_json_path=os.path.join(deep_cluster_folder, filename+".json")
        #     )
