...
def grobid2sht(dataset):
    grobid_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", dataset, "llm_txt_sht")
    ...
    # for json_name in os.listdir(grobid_clustering_dir):
    #     try:
    #         assert json_name.endswith(".json")
    ...
    #     try:
    #         sht_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", dataset, "llm_txt", "sbert.gpt-4o-mini.c100.s100", "sht", f"{file_name}.json")
