...
AGENT_NAME = "react_agent_grep_next_chunk"
...
def run_agent_per_query(dataset, qinfo, model, sht_type):
    ...
    toc_textspan: dict = get_toc_textspan(dataset, qinfo["file_name"], sht_type)
    # doc_txt = get_doc_txt(dataset, qinfo["file_name"])
    toc_greptext: dict = get_toc_greptext(dataset, qinfo["file_name"], sht_type)
