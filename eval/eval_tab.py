...
if __name__ == "__main__":
    ...
    ##########################################End to end
    # tab_str = ""
    # context_len_ratio = 0.4
    # for method in ["vanilla", "raptor", "hipporag", "graphrag", "sht"]:
    #     line_str = method + " & "
    #     # for embedding_mode in ['bm25', 'dpr', 'te3small']:
    #     for embedding_mode in ['sbert']:
    ...
    #             try:
    #                 result = str(round(get_eval_result(context_config, dataset, metric), 2)) + "\%"
    #             except Exception as e:
    #                 print(e)
    #                 print(traceback.print_exc())
    #                 result = "-"
    #             line_str += result + " & "
    #     tab_str += line_str.strip()[:-1] + "\\\\\n"
